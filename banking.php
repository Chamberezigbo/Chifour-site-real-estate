...
$properties = $db->SelectAll("SELECT * FROM product WHERE product_type = 'land_property' ORDER BY RAND() LIMIT $offset, $resultsPerPage");

// Count total properties for pagination
$totalProperties = $db->SelectOne("SELECT COUNT(*) as total FROM product WHERE product_type = 'land_property'", []);
