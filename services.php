...
?>
        ...
        <div class="row">
          ...
          <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
            <div class="box-feature mb-4">
              ...
              <h3 class="text-black mb-3 font-weight-bold">Real Estate Investment</h3>
              <p class="text-black-50">
          ...
          <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
            <div class="box-feature mb-4">
              ...
              <h3 class="text-black mb-3 font-weight-bold">Sales and Leasing</h3>
              <p class="text-black-50">
 ...
 <div class="space-medium" style="background:rgba(0, 0, 0, 0.09);">
        <div class="container">
            <div class="row">
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12 text-center">
                    ...
                    <div class="section-title" style="padding-top:40px;">
                        <h2>Lean More About Our Product and Services</h2>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="video-testimonial-block">
                        <div class="video-thumbnail"><img src="#" alt="" class="img-fluid"></div>
                        <div class="video">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="video-testimonial-block">
                        <div class="video-thumbnail"><img src="imges/img12.jpg" alt="" class="img-fluid"></div>
                        <div class="video">
                            <iframe src="https://www.youtube.com/embed/KEiAVv1UNac" allowfullscreen>
                            </iframe>
                        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="widget">
              <h3>Contact</h3>
              <address>Mercy of God Plaza, Opposite Timber Market,<br> SARS Road, Rumuabholu,<br> Port Harcourt, Rivers State.</address>
              <ul class="list-unstyled links">
                <li><a href="tel://+2347075731811,  +2348033994019">+2347075731811, +2348033994019</a></li>
                <li><a href="tel://+2348035055233">+2348035055233</a></li>
                <!-- <li><a href="tel://+2348033994019">+2348033994019</a></li> -->
                <li>
                  <a href="chi4nigltd@gmail.com">chi4nigltd@gmail.com</a>
                </li>
              </ul>
            </div>
            <!-- /.widget -->
          ...
          <div class="col-lg-4">
            <div class="widget">
              ...
              <ul class="list-unstyled float-start links">
                ...
                <li><a href="agents.html">Realtors</a></li>
                <!-- <li><a href="#">Buy and Build</a></li>
                <li><a href="#">Land Banking</a></li>
                <li><a href="#">Contact Us</a></li> -->
              </ul>

              <ul class="list-unstyled float-start links">
               <li><a href="build.html">Buy and Build</a></li>
                <li><a href="banking.html">Land Banking</a></li>
                <li><a href="contact.html">Contact Us</a></li>
                <!-- <li><a href="#">Bliss Estate</a></li> -->
                <!-- <li><a href="#">FAQ</a></li> -->
                <!-- <li><a href="#">Enterpreneur Estate</a></li> -->
              </ul>
            </div>
            <!-- /.widget -->
          </div>
          ...
          <div class="col-lg-4">
            <div class="widget">
              <h3>Our Estates</h3>
              <ul class="list-unstyled links">
               <li><a href="build.html">Hilltop Haven</a></li>
                <li><a href="build.html">Favour Estate</a></li>
                <li><a href="banking.html">Royal Estate</a></li>
                <li><a href="build.html">Bliss Estate</a></li>
                <li><a href="build.html">City Estate</a></li>
                <li><a href="banking.html">Enterpreneur Estate</a></li>
              </ul>
        ...
        <div class="row mt-5">
          <div class="col-12 text-center">
            ...
            <p>
              ...
              Chifourproperties.com 
              <!-- <a href="https://Chifourproperties.com">Chifourproperties.com</a> -->
...
s1.async=true;
s1.src='https://embed.tawk.to/671d02052480f5b4f5944344/1ib4kvqe6';
s1.charset='UTF-8';
